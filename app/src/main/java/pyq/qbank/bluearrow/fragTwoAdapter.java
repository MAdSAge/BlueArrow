...
public class fragTwoAdapter extends RecyclerView.Adapter<fragTwoAdapter.fragTwoViewHolder> {

    List<entityMcq> mcqList;
    public boolean showAnsers;


    public fragTwoAdapter(List<entityMcq> mcqList, boolean showAnsers) {
    ...
    @NonNull
    @Override
    public fragTwoAdapter.fragTwoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.mcq_layout, parent, false);
        return new fragTwoAdapter.fragTwoViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull fragTwoAdapter.fragTwoViewHolder holder, int position) {
    ...
    private void setOptionColour(entityMcq mcq, fragTwoViewHolder holder, Context context) {
