...
public class mcq_solving extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mcq_model exampleMCQ = new mcq_model(
                1,
                "Wrong Answer?",
                "MCQ001",
                "active",
                "Wrong Answer? What is the largest organ in the human body?",
                "General knowledge",
                "organ_image.png",
                "Heart",
                "Skin",
        ...
        mcq_model exampleMCQ1 = new mcq_model(
                1,
                "Skipped question?",
                "MCQ001",
                "active",
                "Skipped question? What is the largest organ in the human body?",
                "General knowledge",
                "organ_image.png",
                "Heart",
                "Skin",
        ...
        mcq_model exampleMCQ2 = new mcq_model(
                1,
                "true answer?",
                "MCQ001",
                "active",
                "true answer? What is the largest organ in the human body?",
                "General knowledge",
                "organ_image.png",
                "Heart",
                "Skin",
        ...
        mcq_model exampleMCQ3 = new mcq_model(
                1,
                "Book mark false",
                "MCQ001",
                "active",
                "Book mark false What is the largest organ in the human body?",
                "General knowledge",
                "organ_image.png",
                "Heart",
                "Skin",
        ...
        topicList.add(exampleMCQ);
        topicList.add(exampleMCQ1);

        topicList.add(exampleMCQ3);

        topicList.add(exampleMCQ2);// Add as many items as needed
