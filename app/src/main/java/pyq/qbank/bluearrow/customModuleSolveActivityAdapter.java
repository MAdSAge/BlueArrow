...
public class customModuleSolveActivityAdapter extends RecyclerView.Adapter<customModuleSolveActivityAdapter.mcqViewHolder> {

    private final List<entityCustomModuleMcq> filteredMcqList; // Filtered list for displaying
    List<entityCustomModuleMcq> mcqList;
    boolean ReviewMode;
    Box<entityCustomModuleMcq> mcq_box;
    ...
    public customModuleSolveActivityAdapter(List<entityCustomModuleMcq> mcqList, boolean ReviewMode, pasueProgressBar p) {
        this.mcqList = mcqList;
        this.ReviewMode = ReviewMode;
        this.filteredMcqList = new ArrayList<>(mcqList);
        this.pasueProgressBar = p;
        this.mcq_box = boxStore.boxFor(entityCustomModuleMcq.class);
    }

    @NonNull
    @Override
    public customModuleSolveActivityAdapter.mcqViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull mcqViewHolder holder, int position) {
        ...
        entityCustomModuleMcq mcq = filteredMcqList.get(position);
    ...
    private void bookmarkMcq(entityCustomModuleMcq mcq, mcqViewHolder holder) {
    ...
    private void unBookMarkMcq(entityCustomModuleMcq mcq, mcqViewHolder holder) {
    ...
    private void mcqAnswerChecker(entityCustomModuleMcq mcq, mcqViewHolder holder, int selectedAnswer) {
    ...
    public void timeUp(entityCustomModuleMcq currentMcq, mcqViewHolder currentHolder, int i) {
